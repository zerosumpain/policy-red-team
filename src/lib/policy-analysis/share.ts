...
const ID_FIELDS = ['players', 'assumptions', 'resultIds', 'hypothesisIds', 'findingIds', 'candidates', 'mentions', 'dependencies', 'affectedOutcomes', 'targets', 'preconditions', 'inputs', 'actors', 'otherArtefactIds', 'mechanismIds', 'playIds'];
