...
import { Table, Tag, type TagColour } from '../govuk';
...
export function Home() {
  ...
  useEffect(() => {
    api.landing().then((data) => setRows(data.analyses)).catch((err: Error) => setError(err.message));
  }, []);
    ...
    <div className="govuk-grid-row">
      <div className="govuk-grid-column-two-thirds">
        ...
        {/* The router's Link wearing the button class, rather than our Button
            ...
            with role="button" — but an anchor with a plain href reloads the whole
            app to move one page, which in a single-page app is a regression
